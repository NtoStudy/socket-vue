 ...
 */
export const chatRoomCreate = (roomName, userIds) => instance({
 ...
 */
export const chatRoomList = () => instance({
 ...
 */
export const chatRoomUser = (roomId) => instance({
 ...
 * @returns {Promise} - 返回发送聊天室消息请求的Promise对象
 */
export const chatRoomSend = (chatRoomId,content) => instance({
 ...
 */
export const chatRoomHistory = (chatRoomId,pageNum,pageSize) => instance({
 ...
 */
export const chatRoomDelete = (chatRoomId,messageId) => instance({
